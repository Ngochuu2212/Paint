...
namespace Paint.Shapes
{
    public abstract class MyShapes
    {
        ...
        public virtual void Update(bool Fill, bool isDrawBorder, Brush brush, int penWidth, DashStyle dashStyle, Color penColor, float startAngle = 0, float sweepAngle = 0)
        {
            IsFilled = Fill;
