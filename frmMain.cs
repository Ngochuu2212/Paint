...
namespace Paint
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show("Do you want to save this image before exit?", "Warning", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
        ...
        private void FrmMain_SizeChanged(object sender, EventArgs e)
        {
            ...
            InitGraphics();  // Khởi tạo lại đồ họa khi thay đổi kích thước cửa sổ
            RePaint();
        }
        ...
        {
            UpdateSelectedShape();
            pnlDashStyle.Visible = ckbBorder.Checked;
            pnlPenWidth.Visible = ckbBorder.Checked;
        }
        #endregion
        ...
        private void UpdateInfo()
        {
            ...
            GetFocus(lblSelect, true);
            Fill = SelectedShape.IsFilled;
            GetFocus(lblFill, SelectedShape.IsFilled);
            ckbBorder.Checked = true;
            ckbBorder.Enabled = SelectedShape.IsFilled;
        }
        #endregion
        ...
        private void lblFill_BackColorChanged(object sender, EventArgs e)
        {
            pnlForeColor.Visible = Fill;
            pnlBackColor.Visible = Fill;
        }
    }
}